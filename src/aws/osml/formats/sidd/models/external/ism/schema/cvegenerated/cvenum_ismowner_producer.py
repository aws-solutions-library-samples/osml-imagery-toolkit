...
class CVEnumISMOwnerProducerValues(Enum):
    """(U) FGI followed by all currently valid ISO Trigraphs in alphabetical order
    by Trigraph, followed by all currently valid CAPCO Coalition tetragraphs in
    alphabetical order by tetragraph.
    ...
    :cvar USA: Trigraph for United States
